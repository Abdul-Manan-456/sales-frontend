                ...
                <CardContent className="space-y-4">
                    ...
                    >
                        <div>
                            ...
                            <div>
                                <Link href="/auth/forgot-password" className="text-xs text-gray-600 underline hover:text-sky-600">Forgot Password?</Link>
                            </div>
                            <div className="w-full flex flex-col items-center justify-center">
                                <Button disabled={loading} type="submit" className="w-full mt-6 rounded-sm">Login<span className={loading ? "loader ml-3" : ""}></span></Button>
